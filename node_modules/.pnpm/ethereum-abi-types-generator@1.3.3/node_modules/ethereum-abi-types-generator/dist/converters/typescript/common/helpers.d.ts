...
export default class TypeScriptHelpers {
     ...
     */
    static getSolidityInputTsType(abiInput: AbiInput, provider: Provider, prefix?: 'Request' | 'EventEmittedResponse'): string;
    /**
     ...
     */
    static buildInterfaceName(inputOrOutput: AbiOutput | AbiInput, requestInterfaceType?: 'Request' | 'Response' | 'EventEmittedResponse'): string;
    /**
